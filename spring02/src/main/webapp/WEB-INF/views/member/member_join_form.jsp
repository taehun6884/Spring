...
<script type="text/javascript" scr="${pageContext.request.contextPath}/resources/js/jquery-3.6.3.js"></script>
<script type="text/javascript">
	$(function() {
		$('#id').change(function() {
			alert("$(this).val();"+$(this).val());
			let regx = /^[A-Za-z][\w-.]{3,15}$/;
			if(!regx.exec(id)){
				$("#checkIdResult").html("4~16자리 영문,숫자,특수문자(-_.) 필수1");
				$("#checkIdResult").css("color","red");
			}else{
				$("#checkIdResult").html("사용가능한 아이디!");
